...
(function () {
	...
	for (var i = 0; i < names.length; i++) {
		...
		if (firstLetter === 'j') {
			...
			var byeSpeakerRes = (byeSpeaker.speak(name));
			console.log("==========================byeSpeakerNames===========================")
			console.log(byeSpeakerRes)
		//	document.write(byeSpeaker.speak(name) + '<br>');
			document.getElementById("byeSpeakerNames").innerHTML += byeSpeakerRes + '<br>';
			
			

		} else {
			console.log(helloSpeaker.speak(name));
			var helloSpeakerRes = (helloSpeaker.speak(name));
			document.getElementById("helloSpeakerName").innerHTML += helloSpeakerRes + '<br>';
			console.log("==========================helloSpeakerName===========================")
			console.log(helloSpeakerRes)
